...
- Testes
  ...
  - Uso de monkeypatch para simular `pandas_datareader.DataReader` evitando rede.
- Fixtures
...
- Usar `pandas_datareader` monkeypatched simplifica a simulação de fontes e mantém compatibilidade com o código existente (`src.dados_b3`).
