...
- [ ] Draft `docs/playbooks/quickstart-ticker.md` with step-by-step quickstart commands and sample outputs
  - [ ] Include example `poetry run main --ticker PETR4.SA --force-refresh` and expected CSV/snapshot paths
  - [ ] Add verification steps (compute SHA256 checksum, open notebook, expected plots)
- [ ] Draft `docs/playbooks/ux.md` with CLI/Notebook/Streamlit minimal UX expectations
  - [ ] Document CLI flags and example stdout/stderr messages
  - [ ] Document notebook parameters and expected cells/plots
