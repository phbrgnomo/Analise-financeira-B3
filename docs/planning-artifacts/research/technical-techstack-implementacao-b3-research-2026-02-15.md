...
- Coleta: adaptadores em `src/adapters/` com orquestração em `src/ingest/pipeline.py` para obter OHLCV
...
- Sugestão de estrutura: `tests/test_adapters.py`, `tests/test_returns.py` com fixtures que carregam pequenos CSVs de sample.
